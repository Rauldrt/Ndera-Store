...
const SuggestTagsOutputSchema = z.object({
  tags: z
    .array(z.string())
    .describe('An array of suggested tags for the catalog item.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a cataloging expert. Based on the following item description, suggest relevant tags to improve discoverability. Return the tags as a JSON array of strings.

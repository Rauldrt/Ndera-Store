...
const GenerateProductImageOutputSchema = z.object({
  imageUrl: z.string().url().describe('The data URI of the generated product image or a placeholder URL if generation fails.'),
  wasGenerated: z.boolean().describe('Whether the image was generated by AI or is a placeholder.'),
});
...
Description: ${input.description}`,
      ...
      console.error("Error during image generation, falling back to placeholder.", error);
    }
    
    // Fallback to a placeholder image if generation fails or returns no URL
    return {
